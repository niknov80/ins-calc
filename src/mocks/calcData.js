export const calcData = {
  "complexes": [
    {
      "name": "ПАК 'Инсонет' Сервер баз данных",
      "article": "ИНС-С",
      "price": 3120000,
  ...
  "modules": [
    {
      "name": "Модуль администрирования параметров комплекса INS-ADM",
      "article": "01",
      "price": 350000,
    ...
    {
      "name": "Модуль оператора комплекса INS-OPER",
      "article": "02",
      "price": 350000,
      "description": "Описание модуля оператора комплекса",
      "id": "ins-oper",
      "index": 302,
      "isChecked": false
    },
